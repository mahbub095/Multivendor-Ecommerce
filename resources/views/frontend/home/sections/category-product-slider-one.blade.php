            ...
            <div class="col-xl-3 col-sm-6 col-lg-4">
                <div class="wsus__product_item">
                    ...
                    <ul class="wsus__single_pro_icon">
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#product-slider-one"><i class="far fa-eye"></i></a></li>
...
<section class="product_popup_modal">
    <div class="modal fade" id="product-slider-one" tabindex="-1" aria-hidden="true">
