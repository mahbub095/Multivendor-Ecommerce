    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class=""><a class="nav-link" href="">Brands</a></li>
                    <li class="">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class=""><a class="nav-link" href="">Flash Sale</a></li>
                    <li class=""><a class="nav-link" href="">Coupons</a></li>
                    <li class=""><a class="nav-link" href="">Shipping Rule</a></li>
                    <li class=""><a class="nav-link" href="">Vendor Profile</a></li>
            ...
            <li class="dropdown ">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class=""><a class="nav-link" href="">Blog Comments</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown ">
                ...
                <ul class="dropdown-menu">
                    <li class=""><a class="nav-link" href="">Footer Info</a></li>

                    <li class=""><a class="nav-link" href="">Footer Socials</a></li>

                    <li class=""><a class="nav-link" href="">Footer Grid Two</a></li>

                    <li class=""><a class="nav-link" href="">Footer Grid Three</a></li>
                </ul>
            </li>
            <li class="dropdown ">
